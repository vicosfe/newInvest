		...
		<div class="changeUniquePage">
			...
			<div class="changePagesLeft">
				...
				<form action="#" class="changePagesForm">
					...
					<select name="changePages2" id="changePages2">
						<option value="#">Выберите пункт</option>
					</select>
					...
					<div class="changePagesForm__group">      
						<input type="text" name="changeArticleCaption"  required >
			...
			<div class="changePagesRight">
				<h3>Пример добавление уникальной страницы</h3>
				<div class="changePagesRight__content">
					<div class="changePagesRightItem">
						<div class="changePagesRightItem__circle">
							<p>1</p>
						</div>	
						<div class="changePagesRightItem__text">Текст статьи</div>
					</div>
					...
					<div class="changePagesRightItem">
						...
						<div class="changePagesRightItem__text">Заголовок документа</div>
					</div>
					...
					<div class="changePagesRightItem">
						...
						<div class="changePagesRightItem__text">Прикреплённый документ</div>
					</div>
					...
					<div class="changePagesRightItem">
						...
						<div class="changePagesRightItem__text">Текст принадлежащий документу</div>
					</div>
					
					<div class="changePagesRight__content--wrapper">
						...
						<div class="textFileDocPrimer">
							...
							<div class="changePagesRightItem__circle4">
								<p>4</p>
							</div>	
						</div>
